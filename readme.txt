...
* Este plug-in está disponível em Português do Brasil. ([Techload Informatica Computadores](http://www.techload.com.br/))
* Acest plugin este disponibil în limba Română. ([Anunturi Jibo](http://www.jibo.ro/))
* Este plugin está disponível em Português de Portugal. ([Dinis Correia](http://twitter.com/diniscorreia))
* Bu eklentinin Türkçe desteği bulunmaktadır. ([Fatih Aker](http://yazaninsan.com/))
* Questo plug-in è disponibile in Italiano. ([Luca Coralli](http://millerpictures.it/))
* Cette extension est traduite en français. ([Olivier Montbazet](http://lantredekag.fr/))
* این افزونه هم اکنون به زبان فارسی در دسترس است. ([Abbas Karkhane](http://teshneh.com/))
...
= 1.2.18 =
* Fixed the CSS selectors in the default template. 

= 1.2.17 =
* Cleaned up code.
* Added Persian translation by [Abbas Karkhane](http://teshneh.com/).

= 1.2.16 =
* Added French translation by [Olivier Montbazet](http://www.lantredekag.fr/).

= 1.2.15 =
* Added Italian translation by [Luca Coralli](http://millerpictures.it/).

= 1.2.14 =
* Used WP_Enqueue_Style instead of printing HTML.

= 1.2.13 =
* Added Turkish translation by [Fatih Aker](http://yazaninsan.com/).

= 1.2.12 =
* Added Romanian translation by [Anunturi Jibo](http://www.jibo.ro/).
* Added Portuguese translation by [Dinis Correia](http://twitter.com/diniscorreia).

= 1.2.11 =
* Added Portuguese translation by [Techload Informatica Computadores](http://www.techload.com.br/).
